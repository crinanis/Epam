...
namespace AircompanyTests.Tests
{
    ...
    {
        private readonly List<Plane> _planes = new List<Plane>(PlanesList.Planes);
        private readonly PassengerPlane _planeWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);
        private readonly List<Plane> _planesOrderedByMaxLoadCapacity = PlanesList.Planes.OrderBy(x => x.GetMaxLoadCapacity()).ToList();
        [Test]
