...
namespace AircompanyTests.Tests
{
    ...
    {
        private List<Plane> _planes = new List<Plane>(PlanesList.Planes);
        private PassengerPlane _planeWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);
        private List<Plane> _planesOrderedByMaxLoadCapacity = PlanesList.Planes.OrderBy(x => x.GetMaxLoadCapacity()).ToList();
        [Test]
